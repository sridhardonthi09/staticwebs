// Numbers specific functionality
...
function createLearningCard(number, content) {
...
function startLearning() {
    ...
    // Create cards for numbers
    const cardContainer = document.createElement('div');
    cardContainer.className = 'card-container';

    Object.entries(numbersContent).forEach(([number, content]) => {
        const card = createLearningCard(number, content);
