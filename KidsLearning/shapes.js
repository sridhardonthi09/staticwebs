// Shapes specific functionality
const shapesContent = {
    'Circle': { image: 'images/circle.jpg', text: 'Circle', examples: ['⭕'] },
    'Square': { image: 'images/square.jpg', text: 'Square', examples: ['⬛'] },
    'Triangle': { image: 'images/triangle.jpg', text: 'Triangle', examples: ['🔺'] },
    'Rectangle': { image: 'images/rectangle.jpg', text: 'Rectangle', examples: ['⬜'] },
    'Star': { image: 'images/star.jpg', text: 'Star', examples: ['⭐'] }
};
...
function createShapeCard(shape, content) {
...
function startLearning() {
    ...
    Object.entries(shapesContent).forEach(([shape, content]) => {
        const card = createShapeCard(shape, content);
